...
class ThreeLayerConvNet(object):
 ...
 # Forward pass
    ...
    dout_affine_Relu_fast, grads['W3'], grads['b3'] = affine_backward(dscores, cache_affine_fast)
    dout_pool_fast, grads['W2'], grads['b2'] = affine_relu_backward(dout_affine_Relu_fast, cache_affine_Relu_fast)
    dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout_pool_fast, cache_pool_fast)

    # Add regularization to the loss and gradients for W1, W2, and W3
